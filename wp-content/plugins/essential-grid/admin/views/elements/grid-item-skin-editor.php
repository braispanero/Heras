...
<div id="eg-tool-panel">
	<div id="eg-global-css-dialog" class="revpurple eg-side-buttons">
		<i>&lt;/&gt;</i><?php _e('CSS', EG_TEXTDOMAIN); ?>
	</div>
	<div id="eg-global-change" class="revgreen eg-side-buttons">
		<i class="eg-icon-cog"></i><?php _e('Save', EG_TEXTDOMAIN); ?>
	</div>
	<a href="<?php echo $base->getViewUrl("","",'essential-'.Essential_Grid_Admin::VIEW_SUB_ITEM_SKIN_OVERVIEW); ?>" id="eg-global-back-to-overview" class="revblue eg-side-buttons">
		<i class="eg-icon-th"></i><?php _e('Back', EG_TEXTDOMAIN); ?>
	</a>
</div>
...
<div id="skin-editor-wrapper">
	...
	<div style="width:1085px">
		...
		<div style="float:left; width:600px;margin-right:15px;">
							...
							<div id="eg-lc-spaces" class="esg-lc-settings-container">
								...
								<div id="eg-style-full">
									...
									<div style="margin-top:15px">
										...
										<input class="element-setting eg-tooltip-wrap" title="<?php _e('Background Color of Full Item'); ?>" name="full-bg-color" type="text" id="full-bg-color" value="<?php echo $base->getVar($skin['params'], 'full-bg-color', '#ffffff'); ?>" data-default-color="#ffffff">
									</div>
									<p>
										<?php
									...
									<p>
										...
										<input type="radio" name="full-overflow-hidden" value="true" class="firstinput eg-tooltip-wrap" title="<?php _e('Hide Overflow (fix border Radius issues)'); ?>" <?php checked($base->getVar($skin['params'], 'full-overflow-hidden', 'false'), 'true'); ?>> <?php _e('On', EG_TEXTDOMAIN); ?>
										<input type="radio" name="full-overflow-hidden" value="false" class="eg-tooltip-wrap" title="<?php _e('Show Overflowed content'); ?>"<?php checked($base->getVar($skin['params'], 'full-overflow-hidden', 'false'), 'false'); ?>> <?php _e('Off', EG_TEXTDOMAIN); ?>
									</p>
								</div>
									...
									<div style="float:left">
										...
										<div id="eg-cover-animation-bottom">
											...
											<div class="select_wrapper" style="float:right;">
												...
												<input class="input-settings-small element-setting eg-tooltip-wrap" title="<?php _e('Delay before the Animation starts'); ?>" type="text" name="cover-animation-delay-bottom" value="<?php echo $base->getVar($skin['params'], 'cover-animation-delay-bottom', '0', 'i'); ?>" />
											</div>
											<div class="select_wrapper" style="float:right;">
												<div class="select_fake"><span><?php _e('Not uppercased', EG_TEXTDOMAIN); ?></span><i class="eg-icon-sort"></i></div>
			...
			<div class="postbox eg-postbox " style="" id="eg-layersettings-box-wrapper">
				<h3 style="padding:10px;" id="layer-settings-header" class="box-closed">
					...
					<div id="element-setting-wrap-top" style="display:none">
						<form id="eg-item-element-settings-wrap">
							<div id="settings-dz-elements-wrapper" class="eg-ul-tabs">
								<ul>
									<li class="selected-el-setting"><a href="#eg-element-source"><i class="eg-icon-folder-open-empty" style="margin-right:5px;"></i><?php _e('Source', EG_TEXTDOMAIN); ?></a></li>
									<li><a href="#eg-element-style"><i class="eg-icon-droplet" style="margin-right:5px;"></i><?php _e('Style', EG_TEXTDOMAIN); ?></a></li>
									...
									<li><a href="#eg-element-link"><i class="eg-icon-link" style="margin-right:5px;"></i><?php _e('Link/SEO', EG_TEXTDOMAIN); ?></a></li>
								</ul>
								<!--
								SOURCE
								-->
								<div id="eg-element-source">
									<div id="dz-source">
										...
										<div style="margin-top:10px">
											<div id="eg-source-element-drops">
		...
		<div class="postbox eg-postbox" id="eg-it-layout-wrap" style="display:inline-block;"><h3><span class="eg-element-setter"><i style="background-color:#27AE60; padding:3px; margin-right:10px;border-radius:50%;-moz-border-radius:50%;-webkit-border-radius:50%;color:#fff;" class="eg-icon-menu"></i><?php _e('Item Layout', EG_TEXTDOMAIN); ?></span></h3>
			<div class="inside padding-10">			
				...
				<div style="float:right">
					<a href="javascript:void(0);" class="button-primary revgreen" id="drop-1"><?php _e('Hide DropZones', EG_TEXTDOMAIN); ?></a>
				</div>
	...
	******************************** -->
	...
	<div style="margin-top:20px;" class="save-wrap-settings-skin"><a class="button-primary revgreen" href="javascript:void(0);" id="eg-btn-save-grid-editor"><i class="eg-icon-cog"></i><?php echo $save; ?></a></div>
...
//		   TweenLite.to(ic,0.5,{scale:1.3,ease:Power3.easeOut,delay:1});
//		   TweenLite.to(ic,0.5,{scale:1,delay:1.6,ease:Power3.easeOut});
		   TweenLite.to(bw,0.3,{borderColor:"#8E44A9"});
		   TweenLite.to(bw,0.3,{borderColor:"#ccc",delay:0.5});		   
