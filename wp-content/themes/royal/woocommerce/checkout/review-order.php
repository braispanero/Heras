...
<?php if ( ! is_ajax() ) : ?><div id="order_review"><?php endif; ?>
	...
	<div id="payment">
		<h4 class="step-title"><span><?php _e('Payment Method', ETHEME_DOMAIN); ?></span></h4>
		...
		<div class="form-row place-order">
			...
			echo apply_filters( 'woocommerce_order_button_html', '<input type="submit" class="button big alt" name="woocommerce_checkout_place_order" id="place_order" value="' . esc_attr( $order_button_text ) . '" data-value="' . esc_attr( $order_button_text ) . '" />' );
			?>
