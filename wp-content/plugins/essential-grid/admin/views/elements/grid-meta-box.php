		...
		if(!empty($custom_meta)){
			foreach($custom_meta as $cmeta){
				...
				?>
					...
					switch($cmeta['type']){
						case 'text':
							echo '<input type="text" name="eg-cm-'.$cmeta['handle'].'" value="'.$val.'" />';
							break;
						case 'select':
						...
						case 'image':
							...
							?>
							<input type="hidden" value="<?php echo $val; ?>" name="eg-cm-<?php echo $cmeta['handle']; ?>" id="eg-cm-<?php echo $cmeta['handle']; ?>" />
							...
							<div>
								<img id="eg-cm-<?php echo $cmeta['handle']; ?>-img" src="<?php echo $var_src; ?>" <?php echo ($var_src == '') ? 'style="display: none;"' : ''; ?>>
							</div>
							<?php
							break;
					}
