...
<div class="images">
	...
	<?php
		if ( has_post_thumbnail() ) {
            ...
            if($lightbox) $data_rel = 'data-rel="prettyPhoto' . $gallery . '"';
            
            ?>
            
            <div class="product-images-slider main-images images-popups-gallery <?php if ($zoom != 'disable') { echo 'zoom-enabled'; } ?>">
            	<div>
