...
var AdminEssentials = new function(){
	...
	t.getFormParams = function(formID){
		var obj = new Object();
	...
	***********************/
	...
	t.initCreateGrid = function(doAction){
		...
		jQuery('.eg-media-source-order-wrap').sortable({});
		...
		jQuery('body').on('click', '.eg-btn-edit-custom-element', function(){
			...
			if(typeof(data['custom-type']) === 'undefined') return false;
...
/*			jQuery('#eg-lb-twitter').show();
	...
	**/
	...
	t.get_navigation_layout = function(){
		var elements = {pagination:{},left:{},right:{},filter:{},cart:{},sorting:{}}
		...
		if(c_pagination.closest('.eg-navigation-drop-wrapper').attr('id') !== undefined){
			...
			order = c_pagination.parent().children('span').index(c_pagination);
		...
		if(c_left.closest('.eg-navigation-drop-wrapper').attr('id') !== undefined){
			...
			order = c_left.parent().children('span').index(c_left);
		...
		if(c_right.closest('.eg-navigation-drop-wrapper').attr('id') !== undefined){
			...
			order = c_right.parent().children('span').index(c_right);
		...
		if(c_filter.closest('.eg-navigation-drop-wrapper').attr('id') !== undefined){
			...
			order = c_filter.parent().children('span').index(c_filter);
		...
		if(c_cart.closest('.eg-navigation-drop-wrapper').attr('id') !== undefined){
			...
			order = c_cart.parent().children('span').index(c_cart);
		...
		if(c_sort.closest('.eg-navigation-drop-wrapper').attr('id') !== undefined){
			...
			order = c_sort.parent().children('span').index(c_sort);
	...
	***********************/
	...
	t.initSideButtons = function(i) {
		jQuery('.eg-side-buttons').each(function(i) {
			var bt = jQuery(this);
			TweenLite.to(bt,0.3,{right:-55,delay:2+(i*0.1),ease:Power3.easeOut});

			bt.hover(function() {
				TweenLite.to(jQuery(this),0.3,{right:0});
			},function() {
				TweenLite.to(jQuery(this),0.3,{right:-55});
			})
		})
	...
	t.initSmallMenu = function() {
		...
		jQuery('.eg-lc-vertical-menu li').each(function(){
			...
			li.click(function() {
				...
				TweenLite.to(aes,0.1,{autoAlpha:0});
				aes.removeClass("active-esc");

				TweenLite.fromTo(newaes,0.3,{autoAlpha:0},{autoAlpha:1,overwrite:"all"});
	...
	t.interResizeSettings = function () {
		...
		TweenLite.to(ecsw,0.3,{height:ecsw.find('.esg-settings-container.active-esc').outerHeight()+15,overwrite:"all"});
	...
	t.animateElements = function(direction) {
	  ...
	  if (esgAnimmatrix == null)
	    var esgAnimmatrix = [
							...
							['.esg-covergrowup',		0.3, {autoAlpha:1,minHieght:"10px",height:"0%", rotationZ:0,x:0,y:0,scale:1,rotationX:0,rotationY:0,skewX:0,skewY:0},{autoAlpha:1,height:"100%",ease:Power2.easeOut, overwrite:"all"}, 0.3, {autoAlpha:1,height:"0%",ease:Power2.easeOut,overwrite:"all"} ],

				 			['.esg-flipvertical',		0.5, {x:0,y:0,scale:1,rotationZ:0,rotationX:0,rotationY:0,skewX:0,skewY:0,rotationX:180,autoAlpha:0,z:-150,transformOrigin:"50% 50%"}, {rotationX:0,autoAlpha:1,scale:1,z:0.001,ease:Power3.easeInOut,overwrite:"all"} , 0.5,{rotationX:180,autoAlpha:0,scale:1,z:-150,ease:Power3.easeInOut,overwrite:"all"} ],
			 				...
			 				['.esg-fliphorizontal',		0.5, {x:0,y:0,scale:1,rotationZ:0,rotationX:0,rotationY:0,skewX:0,skewY:0,rotationY:180,autoAlpha:0,z:-150,transformOrigin:"50% 50%"}, {rotationY:0,autoAlpha:1,scale:1,z:0.001,ease:Power3.easeInOut,overwrite:"all"} , 0.5, {rotationY:180,autoAlpha:0,scale:1,z:-150,ease:Power3.easeInOut,overwrite:"all"} ],
				 			['.esg-fliphorizontalout',	0.5, {x:0,y:0,scale:1,rotationZ:0,rotationX:0,rotationY:0,skewX:0,skewY:0,rotationY:0,autoAlpha:1,z:0.001,transformOrigin:"50% 50%"}, {rotationY:-180,scale:1,autoAlpha:0,z:-150,ease:Power3.easeInOut,overwrite:"all"} , 0.5, {rotationY:0,autoAlpha:1,scale:1,z:0,ease:Power3.easeInOut,overwrite:"all"} ],

			 				['.esg-flipup',				0.5, {x:0,y:0,scale:0.8,rotationZ:0,rotationX:90,rotationY:0,skewX:0,skewY:0,autoAlpha:0,z:0.001,transformOrigin:"50% 100%"}, {scale:1,rotationX:0,autoAlpha:1,z:0.001,ease:Power2.easeOut,overwrite:"all"} , 0.3, {scale:0.8,rotationX:90,autoAlpha:0,z:0.001,ease:Power2.easeOut,overwrite:"all"} ],
			 				...
			 				['.esg-flipdown',			0.5, {x:0,y:0,scale:1,rotationZ:0,rotationX:-90,rotationY:0,skewX:0,skewY:0,autoAlpha:0,z:0.001,transformOrigin:"50% 0%"},{rotationX:0,autoAlpha:1,y:0,ease:Bounce.easeOut,overwrite:"all"} ,0.3, {autoAlpha:0,rotationX:-90,z:0,ease:Power2.easeOut,overwrite:"all"} ],
			 				...
			 				['.esg-flipright',			0.5, {x:0,y:0,scale:0.8,rotationZ:0,rotationX:0,rotationY:90,skewX:0,skewY:0,autoAlpha:0,transformOrigin:"0% 50%"},{scale:1,rotationY:0,autoAlpha:1,ease:Power2.easeOut,overwrite:"all"} ,0.3,{autoAlpha:0,scale:0.8,rotationY:90,ease:Power3.easeOut,overwrite:"all"} ],
			 				...
			 				['.esg-flipleft',			0.5, {x:0,y:0,scale:1,rotationZ:0,rotationX:0,rotationY:-90,skewX:0,skewY:0,autoAlpha:1,transformOrigin:"100% 50%"},{rotationY:0,autoAlpha:1,z:0.001,scale:1,ease:Power3.easeOut,overwrite:"all"} ,0.3,{autoAlpha:0,rotationY:-90,z:0,ease:Power2.easeOut,overwrite:"all"} ],
			 				...
			 				['.esg-turn',				0.5, {x:50,y:0,scale:0,rotationZ:0,rotationX:0,rotationY:-40,skewX:0,skewY:0,autoAlpha:1,transformOrigin:"50% 50%"},{scale:1,x:0,rotationY:0,autoAlpha:1,ease:Power3.easeInOut,overwrite:"all"} ,0.3,{scale:0,rotationY:-40,autoAlpha:1,z:0,x:50,ease:Power3.easeInOut,overwrite:"all"} ],
			 				...
			 				['.esg-slide',				0.5, {x:0,y:0,scale:1,rotationZ:0,rotationX:0,rotationY:0,skewX:0,skewY:0,autoAlpha:1,transformOrigin:"50% 50%"},{autoAlpha:1,x:0, ease:Power3.easeOut,overwrite:"all"},0.3,{autoAlpha:1,x:0,z:0,ease:Power2.easeOut,overwrite:"all"} ],
			 				['.esg-slideout',			0.5, {autoAlpha:1,x:0, ease:Power3.easeOut,overwrite:"all"},{x:0,y:0,scale:1,rotationZ:0,rotationX:0,rotationY:0,skewX:0,skewY:0,autoAlpha:1,transformOrigin:"50% 50%"},0.3,{autoAlpha:1,x:0, ease:Power3.easeOut,overwrite:"all"}],
			 				...
			 				['.esg-shifttotop',			0.5, {x:0,y:0,scale:1,rotationZ:0,rotationX:0,rotationY:0,skewX:0,skewY:0,autoAlpha:1,transformOrigin:"50% 50%"},{autoAlpha:1,y:"-50%", ease:Power3.easeOut,overwrite:"all"},0.3,{autoAlpha:1,y:0,z:0,ease:Power2.easeOut,overwrite:"all"} ],
			 				...
			 				['.esg-falldown',			0.4, {x:0,scale:1,rotationZ:0,rotationX:0,rotationY:0,skewX:0,skewY:0,autoAlpha:0, y:"-100%"},{autoAlpha:1,y:0,ease:Back.easeOut,overwrite:"all"},0.4,{y:"-40px", autoAlpha:0,z:0,ease:Power2.easeOut,delay:0.2,overwrite:"all"} ],
			 				['.esg-falldownout',		0.4, {autoAlpha:1,y:0,ease:Back.easeOut,overwrite:"all"},{x:0,scale:1,rotationZ:0,rotationX:0,rotationY:0,skewX:0,skewY:0,autoAlpha:0, y:"100%"},0.4,{autoAlpha:1,y:0,ease:Back.easeOut,overwrite:"all"} ],
			 				...
			 				['.esg-zoomback',			0.3, {x:0, y:0,scale:0.2,rotationZ:0,rotationX:0,rotationY:0,skewX:0,skewY:0,autoAlpha:0,transformOrigin:"50% 50%"},{autoAlpha:1,scale:1, x:0, y:0, ease:Power3.easeOut,overwrite:"all"},0.3,{autoAlpha:0,x:0, y:0,scale:0.2,autoAlpha:0,z:0,ease:Power2.easeOut,overwrite:"all"}],
			 				['.esg-zoombackout',		0.3, {autoAlpha:1,scale:1, x:0, y:0, ease:Back.easeOut,overwrite:"all"},{x:0, y:0,scale:0.2,rotationZ:0,rotationX:0,rotationY:0,skewX:0,skewY:0,autoAlpha:0,transformOrigin:"50% 50%"},0.3,{autoAlpha:1,scale:1, x:0, y:0, ease:Power3.easeOut,overwrite:"all"}],
			 				...
			 				['.esg-mediazoom',			0.3, {x:0, y:0,scale:1,rotationZ:0,rotationX:0,rotationY:0,skewX:0,skewY:0,autoAlpha:1,transformOrigin:"50% 50%"},{autoAlpha:1,scale:1.4, x:0, y:0, ease:Back.easeOut,overwrite:"all"},0.3,{x:0, y:0,scale:1,z:0,ease:Power2.easeOut,overwrite:"all"}],
			 				...
			 				['.esg-halftotop',			0.5, {x:0,y:0,scale:1,rotationZ:0,rotationX:0,rotationY:0,skewX:0,skewY:0,autoAlpha:1,transformOrigin:"50% 50%"},{rotationY:0,y:"-50%", autoAlpha:1,scale:1,ease:Power3.easeOut,overwrite:"all"} ,0.3,{rotationY:0,y:0,z:0,autoAlpha:1,scale:1,ease:Power2.easeOut,overwrite:"all"} ],
			 				['.esg-halftobottom',		0.5, {x:0,y:0,scale:1,rotationZ:0,rotationX:0,rotationY:0,skewX:0,skewY:0,autoAlpha:1,transformOrigin:"50% 50%"},{rotationY:0,y:"50%", autoAlpha:1,scale:1,ease:Power3.easeOut,overwrite:"all"} ,0.3,{rotationY:0,y:0,z:0,autoAlpha:1,scale:1,ease:Power2.easeOut,overwrite:"all"} ],
			 				...
			 				['.esg-3dturnright',		0.5, {x:0,y:0,scale:1,rotationZ:0,rotationX:0,rotationY:0,skewX:0,skewY:0,autoAlpha:1,transformPerspective:600},{x:-60,y:0,scale:0.8,rotationZ:2,rotationX:5,rotationY:-28,skewX:-5,skewY:3,autoAlpha:1,transformOrigin:"100% 50% 40%",transformPerspective:600,ease:Power3.easeOut,overwrite:"all"} ,0.3,{x:0,y:0,scale:1,rotationZ:0,rotationX:0,rotationY:0,skewX:0,skewY:0,autoAlpha:1,ease:Power2.easeOut,overwrite:"all"} ]
						 ...
						 TweenLite.set(mc,{transformStyle:"flat"});
						 TweenLite.set(content,{transformStyle:"flat"});
						 TweenLite.set(covergroup,{transformStyle:"flat"});
						 TweenLite.set(media,{transformStyle:"flat"});
						 var nextd =direction;
						...
						if (direction=="last") {
							jQuery.each(esgAnimmatrix,function(index,key) {
								 item.parent().find(key[0]).each(function() {
								 	...
								 	TweenLite.to(item,0.5,{autoAlpha:1,overwrite:"auto",clearProps:"transform"});
								 	TweenLite.to(elem,0.5,{skewX:0, skewY:0, rotationX:0, rotationY:0, rotationZ:0, x:0, y:0, z:0,scale:1,clearProps:"transform",autoAlpha:1,overwrite:"all"});
								 	elem.closest('.eg-editor-inside-wrapper').css({overflow:"hidden"});								 	
								 });
							})
						}
...
******************************************************/
	...
	t.show3danim = function() {
		var orig = jQuery('.eg-editor-inside-wrapper');
				...
				TweenLite.to(jQuery('#eg-it-layout-wrap'),0.5,{backgroundColor:"#d5d5d5"});
				TweenLite.to(orig,0.5,{autoAlpha:0});
				TweenLite.to(mc,0.5,{z:-200,y:-30,autoAlpha:1})
				TweenLite.to(tw,0.3,{minHeight:600});

				//3d MAP STEP1

				TweenLite.set(mci,{z:0,rotationY:0,rotationX:0,overwrite:"all"});
				TweenLite.set(jQuery('#eg-3d-description'),0.5,{autoAlpha:0, delay:3});
				TweenLite.set(elem,{ opacity:1,z:4,overwrite:"all"});
				TweenLite.set(elems,{opacity:1,z:4,overwrite:"all"});
				TweenLite.set(cover,{opacity:1, z:3,overwrite:"all"});
				TweenLite.set(bgcc,{opacity:1, z:2,overwrite:"all"});
				TweenLite.set(bg,{opacity:1, z:1,overwrite:"all"});

				TweenLite.set(mc,{transformStyle:"preserve-3d", transformOrigin:"50% 50% 50%",transformPerspective:1200});
				TweenLite.set(jQuery('.eg-3dmc'),{transformStyle:"preserve-3d", transformOrigin:"50% 50% 50%",transformPerspective:1200});
				TweenLite.set(mci,{transformStyle:"preserve-3d", transformOrigin:"50% 50% 0%",transformPerspective:1200});
				TweenLite.set(elems,{transformStyle:"preserve-3d", transformOrigin:"50% 50% 0%",transformPerspective:1200});
				TweenLite.set(content,{transformStyle:"preserve-3d", transformOrigin:"50% 50% 0%",transformPerspective:1200});
				TweenLite.to(mci,2,{z:0,rotationY:-45,rotationX:7,delay:0.5,overwrite:"all",ease:Power1.easeOut});



				// STEP2
				TweenLite.to(elem,1,{z:90,overwrite:"all",delay:1,ease:Power1.easeOut});
				TweenLite.to(cover,0.7,{z:50,overwrite:"all" ,delay:1,ease:Power1.easeOut});
				TweenLite.to(bgcc,0.5,{z:22,overwrite:"all",delay:1,ease:Power1.easeOut});
				TweenLite.to(bg,0.5,{z:20,overwrite:"all",delay:1,ease:Power1.easeOut});



				// STEP3
				TweenLite.to(jQuery('#eg-3d-description'),0.5,{autoAlpha:1, delay:3});
				TweenLite.fromTo(st1,0.5,{autoAlpha:0,y:-10},{autoAlpha:1, y:0,delay:3});
				TweenLite.to(elems,0.5,{opacity:1,delay:3});
				TweenLite.to(cover,0.5,{opacity:0,delay:3});
				TweenLite.to(content,0.5,{opacity:0,delay:3});
				TweenLite.to(bg,0.5,{opacity:0,delay:3});

				// STEP4
				TweenLite.to(st1,0.5,{autoAlpha:0, delay:4.5});
				TweenLite.fromTo(st2,0.5,{autoAlpha:0,y:-10},{autoAlpha:1, y:0,delay:4.5});
				TweenLite.to(elems,0.5,{opacity:0,delay:4.5});
				TweenLite.to(cover,0.5,{opacity:1,delay:4.5});

				// STEP5
				TweenLite.to(st2,0.5,{autoAlpha:0, delay:6});
				TweenLite.fromTo(st3,0.5,{autoAlpha:0,y:-10},{autoAlpha:1, y:0,delay:6});
				TweenLite.to(cover,0.5,{opacity:0,delay:6});
				TweenLite.to(bg,0.5,{opacity:1,delay:6});

				// STEP5
				TweenLite.to(st3,0.5,{autoAlpha:0, delay:7.5});
				TweenLite.fromTo(st4,0.5,{autoAlpha:0,y:-10},{autoAlpha:1, y:0,delay:7.5});
				TweenLite.to(content,0.5,{opacity:1,delay:7.5});
				TweenLite.to(bg,0.5,{opacity:0,delay:7.5});
	...
	t.hide3danim = function() {
				...
				TweenLite.to(jQuery('#eg-it-layout-wrap'),0.5,{backgroundColor:"#fff"});
				TweenLite.to(mc,0.5,{z:0,y:0,autoAlpha:0})
				TweenLite.to(orig,0.5,{autoAlpha:1});
				TweenLite.to(tw,0.3,{minHeight:0});

				//3d MAP
				TweenLite.set(st1,{autoAlpha:0,overwrite:"all"});
				TweenLite.set(st2,{autoAlpha:0,overwrite:"all"});
				TweenLite.set(st3,{autoAlpha:0,overwrite:"all"});
				TweenLite.set(st4,{autoAlpha:0,overwrite:"all"});
				TweenLite.to(content,0.5,{opacity:1,overwrite:"all"});

				TweenLite.to(mci,0.5,{z:0,rotationY:0,rotationX:0,overwrite:"all"});
				TweenLite.to(jQuery('#eg-3d-description'),0.5,{autoAlpha:0, delay:3});
				TweenLite.to(elem,0.5,{ opacity:1,z:4,overwrite:"all"});
				TweenLite.to(elems,0.5,{opacity:1,z:4,overwrite:"all"});
				TweenLite.to(cover,0.5,{opacity:1, z:3,overwrite:"all"});
				TweenLite.to(bgcc,0.5,{opacity:1, z:2,overwrite:"all"});
				TweenLite.to(bg,0.5,{opacity:1, z:1,overwrite:"all"});
	}
