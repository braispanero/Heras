 ...
 */
	...
	LEFT SETTINGS
	-->
	<h2><?php echo esc_html(get_admin_page_title()); ?> - <?php echo $title; ?></h2>
	<div class="postbox eg-postbox" style="width:100%;min-width:500px"><h3><span><?php _e('Layout Composition', EG_TEXTDOMAIN); ?></span><div class="postbox-arrow"></div></h3>
        <div class="inside" style="padding:0px !important;margin:0px !important;height:100%;position:relative;background:#ebebeb">
			...
			<div id="eg-create-settings-menu">
			  	<ul>
			  		<li style="width:150px; background:#EBEBEB;position:absolute;height:100%;top:0px;left:0px;box-sizing:border-box;
					...
					<li class="" data-toshow="esg-settings-filterandco-settings"><i class="eg-icon-shuffle"></i><p><?php _e('Navigations', EG_TEXTDOMAIN); ?></p></li>
					...
					<li class="" data-toshow="esg-settings-video-settings"><i class="eg-icon-video"></i><p><?php _e('Video', EG_TEXTDOMAIN); ?></p></li>					
								...
								<div class="eg-cs-tbc">
									...
									<div id="eg-additional-post">
										...
										<div style="float: left">
											<input type="text" name="additional-query" class="eg-tooltip-wrap" title="<?php _e('Please use it like \'year=2012&monthnum=12\''); ?>" value="<?php echo $base->getVar($grid['postparams'], 'additional-query', ''); ?>" />
											<p><?php _e('Please use it like \'year=2012&monthnum=12\' or \'post__in=array(1,2,5)&post__not_in=array(25,10)\''); ?>&nbsp;-&nbsp;
											<?php _e('For a full list of parameters, please visit <a href="https://codex.wordpress.org/Class_Reference/WP_Query" target="_blank">this</a> link'); ?></p>
										</div>
			...
			<div class="save-wrap-settings">
				<div style="width:150px; background:#EBEBEB;position:absolute;height:100%;top:0px;left:0px;"></div>
