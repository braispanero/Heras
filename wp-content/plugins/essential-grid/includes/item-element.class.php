...
class Essential_Grid_Item_Element {
	...
	public static function getPostElementsArray(){
		...
		$post = array(
			'title' => array('name' => __('Post Title', EG_TEXTDOMAIN)),
			'excerpt' => array('name' => __('Post Excerpt', EG_TEXTDOMAIN)),
			'meta' => array('name' => __('Post Meta'), EG_TEXTDOMAIN),
			'alias' => array('name' => __('Post Alias', EG_TEXTDOMAIN)),
			'content' => array('name' => __('Post Content', EG_TEXTDOMAIN)),
			'date' => array('name' => __('Post Date', EG_TEXTDOMAIN)),
			'date_modified' => array('name' => __('Post Date Modified', EG_TEXTDOMAIN)),
			'author_name' => array('name' => __('Post Author Name', EG_TEXTDOMAIN)),
			'num_comments' => array('name' => __('Post Num. Comments', EG_TEXTDOMAIN)),
			'cat_list' => array('name' => __('Post Cat. List', EG_TEXTDOMAIN)),
			'tag_list' => array('name' => __('Post Tag List', EG_TEXTDOMAIN))
		);
	...
	public static function getElementsForJavascript(){
		...
		$all = array_merge($default, $text, $special);
